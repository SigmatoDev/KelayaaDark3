  ...
  const cards = [
    {
      id: 1,
      title: "Gold & Diamond",
      image: "/images/categories/goldanddiamond.webp",
    },
    { id: 2, title: "Silver", image: "/images/categories/silvercustom.webp" },
    {
      id: 3,
      title: "Gem Stone",
      image: "/images/categories/customgemstones.webp",
    },
    ...
    <>
      ...
      <div className="text-center">
        ...
        <p className="text-center mb-6 text-gray-400 font-light text-sm">
          Every piece we craft is a timeless expression of your unique story,
          designed to shine with elegance and meaning.
        </p>
      </div>
