...
const CategoryCard = ({ category }: { category: Category }) => {
  return (
    ...
    className="group relative w-full h-[420px] overflow-hidden rounded-xl shadow-md transition-all"
  >
...
const CategoryGrid = () => {
  return (
    <div className="px-4 mt-16">
      ...
      <p className="text-center mb-8 text-gray-400 font-light text-sm">From everyday essentials to statement styles — explore our collections and find what speaks to you.
