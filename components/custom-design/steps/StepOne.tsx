  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-2">
        <label className="block text-sm font-medium">I am designing for</label>
      ...
      {/* Design Type */}
      <div className="space-y-2">
        <label className="block text-sm font-medium">I would like to Design</label>
      ...
      <div className="pt-6">
        <button
          ...
          className="w-full bg-gradient-to-r from-pink-500 to-orange-400 text-white py-3 rounded-lg hover:opacity-90 transition disabled:opacity-50 disabled:cursor-not-allowed"
        >
          Next Step
        </button>
      </div>
