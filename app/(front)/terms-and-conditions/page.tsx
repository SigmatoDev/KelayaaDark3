...
export default function TermsOfUse() {
  return (
    <div className="max-w-4xl mx-auto p-6">
      ...
      <p className="mb-4">Last updated: 03 March 2025</p>

      <section className="mb-6">
        <h2 className="text-xl font-semibold mb-2">1. Introduction</h2>
        <p>
          Welcome to Kelayaa. These Terms of Use govern your access to and use
          of our website and services. By using our website, you agree to abide
          by these terms.
        </p>
      </section>
      ...
      <section className="mb-6">
        ...
        <p>
          ...
          the property of Kelayaa and is protected by applicable copyright and
          trademark laws.
        </p>
      </section>
      ...
      <section className="mb-6">
        ...
        <p>
          You agree not to misuse our services, including attempting
          unauthorized access, distributing malware, or engaging in any activity
          that disrupts our website.
        </p>
      </section>
      ...
      <section className="mb-6">
        ...
        <p>
          ...
          maintaining its confidentiality and for all activities under your
          account.
        </p>
      </section>
      ...
      <section className="mb-6">
        ...
        <p>
          Kelayaa is not liable for any damages resulting from your use of our
          website. Our services are provided on an "as-is" basis.
        </p>
      </section>
